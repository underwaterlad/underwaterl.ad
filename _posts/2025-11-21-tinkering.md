---
layout: post
title: "tinkering update"
date: 2025-11-21
---
Making the site work on mobile devices/vertical viewports was pretty easy, actually. I thought I would be rewriting whole chunks of markup, but as it turns out you can just create CSS rules that apply only once the viewport hits a particular width or aspect ratio. A long time ago I did a short website-building course which taught [Bootstrap](https://getbootstrap.com/) and it was pure death from what I can remember. A couple of things remain to update, mainly the [works page](https://underwaterl.ad/works) which looks a tad too static and uninteresting.
